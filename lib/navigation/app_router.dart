...
/// Использует кастомные переходы для плавной навигации.
///
/// **Архитектура:**
/// - Статические поля хранят общие зависимости (API клиент, сервисы)
/// - `onGenerateRoute` создает маршруты с плавными переходами
/// - Поддерживает платформо-специфичные переходы (мобильные/десктоп)
///
/// **Использование:**
/// ```dart
/// MaterialApp(
